...
public class ToString {
	...
	public static void PrepareSql(PreparedStatement ps,int index,String value,String type) throws SQLException{
		...
		case "int":
			ps.setInt(index,ToString.str2int(value));
			break;
			
		case "Timestamp" :
			ps.setTimestamp(index, ToString.str2date(value));
			break;
		
		case "double":
			ps.setDouble(index, ToString.str2double(value));
			break;
